...
export default function ReportViewer({ filename, onBack }: ReportViewerProps) {
  ...
  const chartOptions: ChartOptions<'line'> = {
    ...
    plugins: {
      legend: { labels: { color: '#9198a1', font: { size: 11 }, boxWidth: 12, padding: 12 } },
      tooltip: {
    ...
    scales: {
      x: {
        grid: { color: 'rgba(61,68,77,0.6)' },
        ticks: { color: '#9198a1', font: { size: 10 }, maxTicksLimit: 10 },
      },
      y: {
        grid: { color: 'rgba(61,68,77,0.6)' },
        ticks: { color: '#9198a1', font: { size: 10 } },
        beginAtZero: true,
      },
    },
  }
